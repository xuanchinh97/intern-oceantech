...
function load() {
    ...
    if (so < 0 && so != null) {
        document.getElementById("loiso").innerHTML = "Nhập số ô lớn hơn 0"
        check = false
    }
    ...
    if (chieudai < 0 && chieudai != null) {
        document.getElementById("loichieudai").innerHTML = "Nhập width lớn hơn 0"
        check = false
    }
    ...
    if (chieurong < 0 && chieurong != null) {
        document.getElementById("loichieurong").innerHTML = "Nhập height lớn hơn 0"
        check = false
    }
    ...
    if (margin < 0 && margin != null) {
        document.getElementById("loimargin").innerHTML = "Nhập margin lớn hơn 0"
        check = false
    }
